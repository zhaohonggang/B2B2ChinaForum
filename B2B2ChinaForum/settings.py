"""
Django settings for B2B2ChinaForum project.
...
SECRET_KEY = '7(v5os=%ju#gl%!latg$ln(lnaw&#oguf!3(42@!gjzuv2+7ky'
...
ROOT_URLCONF = 'B2B2ChinaForum.urls'
...
WSGI_APPLICATION = 'B2B2ChinaForum.wsgi.application'
